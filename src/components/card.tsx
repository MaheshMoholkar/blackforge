...
function Card(
  ...
  return (
    <div
      className={twMerge(
        "relative z-0 p-8 md:p-10 group cursor-default",
        className
      )}
    >
      <div
        className={twMerge(
          "absolute size-16 rounded-xl bg-fuchsia-500 top-1.5 right-1.5 -z-10 blur-lg transition duration-300 opacity-0 group-hover:opacity-100",
